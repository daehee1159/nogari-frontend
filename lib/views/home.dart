...
import 'package:nogari/views/community/paging_community.dart';
import 'package:nogari/views/home/home_page.dart';
import 'package:nogari/views/home/man_hour_main.dart';
import 'package:nogari/views/home/notification_page.dart';
import 'package:nogari/views/review/paging_review.dart';
import 'package:nogari/views/settings/settings.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    Future.microtask(() async {
      ...
      if(mounted && appVersionViewModel.getAppVersion!.android != packageInfo.version) {
        showDialog(
            context: context,
