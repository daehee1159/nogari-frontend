...
class _ReviewSearchPageState extends State<ReviewSearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder(
          future: _reviewRepository.getSearchReview(widget.type, widget.searchCondition, widget.keyword, (widget.type == 'like') ? reviewViewModel.getLikeCount : null, reviewViewModel.getCurrentPage, reviewViewModel.getSize),
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              reviewViewModel.setSearchReviewList = reviewData.list;
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: viewModel.getSearchReviewList.length,
                                      ...
                                      children: [
                                        Material(
                                          ...
                                          child: InkWell(
                                                ...
                                                children: [
                                                        ...
                                                        Expanded(
                                                          child: Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Text(
                                                                  viewModel.getSearchReviewList[index].title,
                                                                  style: Theme.of(context).textTheme.bodyMedium,
                                                                ),
                                                              ],
                                                            ),
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Expanded(
                                                                  child: Text(
                                                                    'Lv.${viewModel.getSearchReviewList[index].level} ${viewModel.getSearchReviewList[index].nickname}',
                                                                    style: Theme.of(context).textTheme.bodySmall,
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    viewModel.getSearchReviewList[index].regDt.toString().substring(0, 10),
                                                                    style: Theme.of(context).textTheme.bodySmall,
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '조회 ${viewModel.getSearchReviewList[index].viewCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall,
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '추천 ${viewModel.getSearchReviewList[index].likeCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall,
                                                                  ),
                                                                )
                                                              ],
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          viewModel.getCntOfComment[viewModel.getSearchReviewList[index].boardSeq].toString(),
                                                          style: Theme.of(context).textTheme.bodyMedium,
                                                        ),
                                                      ),
                                                    ),
                                            ...
                                            onTap: () async {
                                              // 이건 비동기 안해도 됨
                                              await _reviewRepository.addBoardViewCnt(viewModel.getSearchReviewList[index].boardSeq);

                                              if (mounted) {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewDetailPage(review: viewModel.getSearchReviewList[index])));
                                              }
