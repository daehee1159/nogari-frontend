...
class _LikeReviewListState extends State<LikeReviewList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: _reviewRepository.getLikeReviewList(reviewViewModel.getCurrentPage, reviewViewModel.getSize, reviewViewModel.getLikeCount),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            reviewViewModel.setLikeReviewList = reviewData.list;
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: viewModel.getLikeReviewList.length,
                                      ...
                                      children: [
                                        Material(
                                          ...
                                          child: InkWell(
                                                ...
                                                children: [
                                                        ...
                                                        Expanded(
                                                          child: Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Text(
                                                                  viewModel.getLikeReviewList[index].title,
                                                                  style: Theme.of(context).textTheme.bodyMedium,
                                                                ),
                                                              ],
                                                            ),
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Expanded(
                                                                  child: Text(
                                                                    'Lv.${viewModel.getLikeReviewList[index].level} ${viewModel.getLikeReviewList[index].nickname}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    viewModel.getLikeReviewList[index].regDt.toString().substring(0, 10),
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '조회 ${viewModel.getLikeReviewList[index].viewCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '추천 ${viewModel.getLikeReviewList[index].likeCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                )
                                                              ],
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          viewModel.getCntOfComment[viewModel.getLikeReviewList[index].boardSeq].toString(),
                                                          style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                        ),
                                                      ),
                                                    ),
                                            ...
                                            onTap: () async {
                                              // 이건 비동기 안해도 됨
                                              await _reviewRepository.addBoardViewCnt(viewModel.getLikeReviewList[index].boardSeq);

                                              if (mounted) {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewDetailPage(review: viewModel.getLikeReviewList[index])));
                                              }
                                            },
                                          ),
                                        ),
