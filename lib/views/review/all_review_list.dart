...
class _AllReviewListState extends State<AllReviewList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: _reviewRepository.getReviewList(reviewViewModel.getCurrentPage, reviewViewModel.getSize),
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemCount: viewModel.getReviewList.length,
                                ...
                                children: [
                                  Material(
                                    ...
                                    child: InkWell(
                                          ...
                                          children: [
                                                  ...
                                                  Expanded(
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Text(
                                                            viewModel.getReviewList[index].title,
                                                            style: Theme.of(context).textTheme.bodyMedium,
                                                          ),
                                                        ],
                                                      ),
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Expanded(
                                                            child: Text(
                                                              'Lv.${viewModel.getReviewList[index].level} ${viewModel.getReviewList[index].nickname}',
                                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                            ),
                                                          ),
                                                          Expanded(
                                                            child: Text(
                                                              viewModel.getReviewList[index].regDt.toString().substring(0, 10),
                                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                            ),
                                                          ),
                                                          Expanded(
                                                            child: Text(
                                                              '조회 ${viewModel.getReviewList[index].viewCnt}',
                                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                            ),
                                                          ),
                                                          Expanded(
                                                            child: Text(
                                                              '추천 ${viewModel.getReviewList[index].likeCnt}',
                                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                            ),
                                                          )
                                                        ],
                                            ...
                                            Expanded(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    viewModel.getCntOfComment[viewModel.getReviewList[index].boardSeq].toString(),
                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                  ),
                                                ),
                                              ),
                                      ...
                                      onTap: () async {
                                        // 이건 비동기 안해도 됨
                                        await _reviewRepository.addBoardViewCnt(viewModel.getReviewList[index].boardSeq);

                                        List<ReviewLike> fetchData = await _reviewRepository.getBoardLikeCnt(viewModel.getReviewList[index].boardSeq);

                                        for (int i = 0; i < fetchData.length; i++) {
                                          if (fetchData[i].memberSeq == memberViewModel.getMemberSeq) {
                                            viewModel.getReviewList[index].isMyPress = true;
                                          }
                                        }

                                        if (mounted) {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewDetailPage(review: viewModel.getReviewList[index])));
                                        }
                                      },
                                    ),
                                  ),
