...
import 'package:nogari/views/home/news_more_page.dart';
import 'package:nogari/views/home/point_page.dart';
import 'package:nogari/views/home/scientificCalCulator.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: PageView.builder(
                ...
                itemCount: newsViewModel.getRandomNewsList.length + 1,
                itemBuilder: (context, index) {
                  if (index < newsViewModel.getRandomNewsList.length) {
                    return NewsCard(news: newsViewModel.getRandomNewsList[index]);
                  } else {
                    return GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => NewsMorePage(newsList: newsViewModel.getNewsList,))
                        );
                      },
                    );
                  }
