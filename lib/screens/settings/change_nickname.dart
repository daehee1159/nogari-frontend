...
class _ChangeNickNameState extends State<ChangeNickName> {
  ...
  void didChangeDependencies() {
    ...
    nickNameController.text = Provider.of<MemberInfoProvider>(context, listen: false).getNickName.toString();
  }
                          ...
                          if (!_isNicknameAvailable) {
                            ...
                            if (tempNickName == currentNickName) {
                              ...
                              if (result) {
                                ...
                                // 중복이 아니므로 가입 완료
                                bool result = await MemberService().updateNickName(currentNickName);

                                if (result) {
                                  // 성공
                                  memberInfoProvider.setNickName = currentNickName;
                                  if (mounted) {
