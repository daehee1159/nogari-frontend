...
import 'package:nogari/screens/settings/app_version.dart';
import 'package:nogari/screens/settings/block_list_page.dart';
import 'package:nogari/screens/settings/change_nickname.dart';
import 'package:nogari/screens/settings/my_board_page.dart';
import 'package:nogari/screens/settings/withdrawal_page.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ItemCard(
                      ...
                      textColor: Colors.black,
                      callback: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const BlockListPage()));
                      },
                    ),
                    const SizedBox(height: 10,),
                    ItemCard(
                    ...
                    ItemCard(
                      ...
                      textColor: Colors.black,
                      rightWidget: Center(
                        child: Text(appVersionProvider.getCurrentAppVersion!,
