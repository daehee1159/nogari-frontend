...
class _WithdrawalPageState extends State<WithdrawalPage> {
  ...
  final MemberAlert memberAlert = MemberAlert();
          ...
          child: Column(
            children: [
              ...
              TextButton(
                ...
                onPressed: () async {
                  bool result = await memberService.withdrawalMember(textEditingController.text);
                  bool prefResult = await memberService.withdrawalMemberPref();

                  if (mounted) {
                    memberAlert.withdrawalAlert(context);
                  }
                },
                child: Text(
                  '탈퇴하기',
