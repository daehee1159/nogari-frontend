...
class LikeReviewList extends StatefulWidget {
  const LikeReviewList({super.key});

  @override
  State<LikeReviewList> createState() => _LikeReviewListState();
}

class _LikeReviewListState extends State<LikeReviewList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: reviewService.getLikeReviewList(reviewProvider.getCurrentPage, reviewProvider.getSize, reviewProvider.getLikeCount),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            reviewProvider.setLikeReviewList = reviewDataDto.list;
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: reviewProvider.getLikeReviewList.length,
                                      ...
                                      children: [
                                        Material(
                                          ...
                                          child: InkWell(
                                                ...
                                                children: [
                                                        ...
                                                        Expanded(
                                                          child: Container(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Text(
                                                                  reviewProvider.getLikeReviewList[index].title,
                                                                  style: Theme.of(context).textTheme.bodyMedium,
                                                                ),
                                                              ],
                                                            ),
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Expanded(
                                                                  child: Text(
                                                                    'Lv.${reviewProvider.getLikeReviewList[index].level} ${reviewProvider.getLikeReviewList[index].nickname}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    reviewProvider.getLikeReviewList[index].regDt.toString().substring(0, 10),
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '조회 ${reviewProvider.getLikeReviewList[index].viewCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                ),
                                                                Expanded(
                                                                  child: Text(
                                                                    '추천 ${reviewProvider.getLikeReviewList[index].likeCnt}',
                                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                                  ),
                                                                )
                                                              ],
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          reviewProvider.getCntOfComment[reviewProvider.getLikeReviewList[index].boardSeq].toString(),
                                                          style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 11),
                                                        ),
                                                      ),
                                                    ),
                                            ...
                                            onTap: () async {
                                              // 이건 비동기 안해도 됨
                                              await reviewService.addBoardViewCnt(reviewProvider.getLikeReviewList[index].boardSeq);

                                              if (mounted) {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewDetailPage(review: reviewProvider.getLikeReviewList[index])));
                                              }
                                            },
                                          ),
                                        ),
                                ...
                                const ReviewSearchBar(type: 'like', isFirstTime: true,)
                              ],
                            ),
                          );
                        }
