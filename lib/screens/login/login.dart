...
import 'package:nogari/screens/login/create_nickname.dart';
import 'package:nogari/services/member_service.dart';
import 'package:nogari/models/common/temp_nogari.dart';
import 'package:nogari/screens/login/login_result.dart';
            ...
            child: SignInWithAppleButton(
              ...
              onPressed: () async {
                ...
                if (loginAvailable) {
                  ...
                  String memberStatus = await MemberService().getMemberStatus(email, 'iOS', identifier);
                  ...
                  // UNIDENTIFIED 가 나오면 오류임
                    ...
                    case 'UNSUBSCRIBED':
                    /// 미가입 상태
                      bool setEmailResult = await MemberService().setEmail(email);
                      bool setIdentifier = await MemberService().setIdentifier(identifier);
                    ...
                    case 'WITHDRAWAL':
                      ...
                      break;
                    default:
                      bool result = await MemberService().changeDeviceToken(email);
                      if (result) {
                        int memberSeq = await MemberService().getMemberSeqByEmail(email);
                        bool setMemberSeq = await MemberService().setMemberSeq(memberSeq);
