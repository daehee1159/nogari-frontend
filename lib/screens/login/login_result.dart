        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            return FutureBuilder(
                future: MemberService().getMemberStatus(snapshot.data.toString(), Platform.isAndroid ? 'Android' : 'iOS', null),
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  bool result = await MemberService().setEmail(_accountEmail);
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (result) {
                                      bool updateResult = await MemberService().changeDeviceToken(_accountEmail);
