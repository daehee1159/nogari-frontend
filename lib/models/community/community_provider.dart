...
class CommunityProvider extends ChangeNotifier {
  ...
  CommunityDataDto? tempCommunityData;
  ...
  CommunityDataDto? get getCommunityData => communityData;
  ...
  CommunityDataDto? get getTempCommunityData => tempCommunityData;
  ...
  set setCommunityData(CommunityDataDto communityDataDto) {
    communityData = communityDataDto;
    // notifyListeners();
  }
  ...
  set setTempCommunityData(CommunityDataDto? communityDataDto) {
    tempCommunityData = communityDataDto;
    // notifyListeners();
  }
